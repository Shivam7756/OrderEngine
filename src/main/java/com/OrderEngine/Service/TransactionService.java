...
public class TransactionService {
    ...
    public void calculateStock(BuyerDtls buyerDtls)
    {
        Integer quantity = 0;
        ...
        for(int i = 0;i<sdtls.size();i++)
        {
           ...
           if(buyerDtls.getBuyPrice()<curSellerDtls.getSellPrice())
               break;
           else if(buyerDtls.getQuantity()==0)
               break;
    ...
    public ArrayList showUnfulfilledOrders() {
        return null;
    }
}
